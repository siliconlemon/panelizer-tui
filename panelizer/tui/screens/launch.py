...
class LaunchScreen(Screen[bool]):
    ...
    ::
        ...
        class MyLaunchScreen(LaunchScreen):
            ASCII_ART_DIR = Path(__file__).parent / "assets"
            ASCII_ART_VARIANTS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Container(id="main"):
            ...
            with Container(id="buttons"):
                yield NeonButton("Enter", id="enter", classes="launch-btn", variant="primary")
                yield NeonButton("Exit", id="exit", classes="launch-btn", variant="primary")
