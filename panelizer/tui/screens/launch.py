...
from ..widgets import TheButton, InertLabel
    ...
    def compose(self) -> ComposeResult:
        ...
        with Container(id="launch-container"):
            ...
            with Container(id="button-container"):
                yield TheButton("Pick a Directory", id="pick-dir", classes="wide-btn", variant="primary")
                yield TheButton("Current Directory", id="current-dir", classes="wide-btn", variant="primary")
